...
import com.opencode.test.service.FrontpageconfigQueryService;
...
/**
 * REST controller for managing {@link com.opencode.test.domain.Frontpageconfig}.
 */
@RestController
@RequestMapping("/api/frontpageconfigs")
public class FrontpageconfigResource {

    private static final Logger LOG = LoggerFactory.getLogger(FrontpageconfigResource.class);
    ...
    public ResponseEntity<FrontpageconfigDTO> createFrontpageconfig(@Valid @RequestBody FrontpageconfigDTO frontpageconfigDTO)
        ...
        frontpageconfigDTO = frontpageconfigService.save(frontpageconfigDTO);
        return ResponseEntity.created(new URI("/api/frontpageconfigs/" + frontpageconfigDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, frontpageconfigDTO.getId().toString()))
            .body(frontpageconfigDTO);
    }
    ...
    public ResponseEntity<FrontpageconfigDTO> updateFrontpageconfig(
        ...
        frontpageconfigDTO = frontpageconfigService.update(frontpageconfigDTO);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FrontpageconfigDTO>> getAllFrontpageconfigs(
        FrontpageconfigCriteria criteria,
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<FrontpageconfigDTO> getFrontpageconfig(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteFrontpageconfig(@PathVariable("id") Long id) {
