...
public class Appuser implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "blockeduser")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "blockinguser")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "blockeduser", "blockinguser", "cblockeduser", "cblockinguser" }, allowSetters = true)
    ...
    @ManyToMany(fetch = FetchType.LAZY, mappedBy = "appusers")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
