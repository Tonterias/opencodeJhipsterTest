...
/**
 * Service Interface for managing {@link com.opencode.test.domain.Cactivity}.
 */
public interface CactivityService {
     ...
     * Updates a cactivity.
     *
     * @param cactivityDTO the entity to update.
     * @return the persisted entity.
     */
    CactivityDTO update(CactivityDTO cactivityDTO);
