...
import { AppuserDeleteDialog } from './appuser-delete-dialog';

describe('Appuser Management Delete Component', () => {
  let comp: AppuserDeleteDialog;
  let fixture: ComponentFixture<AppuserDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AppuserDeleteDialog);
