...
describe('Topic Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Topic', () => {
      ...
      service.create(topic).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Topic', () => {
      ...
      service.update(topic).subscribe(resp => (expectedResult = resp));
    ...
    describe('addTopicToCollectionIfMissing', () => {
      it('should add a Topic to an empty array', () => {
        ...
        expect(expectedResult).toEqual([topic]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([topic, topic2]);
      });
