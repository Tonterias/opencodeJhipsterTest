...
import { CcelebDeleteDialog } from './cceleb-delete-dialog';

describe('Cceleb Management Delete Component', () => {
  let comp: CcelebDeleteDialog;
  let fixture: ComponentFixture<CcelebDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CcelebDeleteDialog);
