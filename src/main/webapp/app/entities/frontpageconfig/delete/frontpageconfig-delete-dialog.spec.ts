...
import { FrontpageconfigDeleteDialog } from './frontpageconfig-delete-dialog';

describe('Frontpageconfig Management Delete Component', () => {
  let comp: FrontpageconfigDeleteDialog;
  let fixture: ComponentFixture<FrontpageconfigDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(FrontpageconfigDeleteDialog);
