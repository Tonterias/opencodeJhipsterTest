...
import { CinterestDeleteDialog } from './cinterest-delete-dialog';

describe('Cinterest Management Delete Component', () => {
  let comp: CinterestDeleteDialog;
  let fixture: ComponentFixture<CinterestDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CinterestDeleteDialog);
