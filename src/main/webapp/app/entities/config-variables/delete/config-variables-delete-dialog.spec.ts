...
import { ConfigVariablesDeleteDialog } from './config-variables-delete-dialog';

describe('ConfigVariables Management Delete Component', () => {
  let comp: ConfigVariablesDeleteDialog;
  let fixture: ComponentFixture<ConfigVariablesDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ConfigVariablesDeleteDialog);
