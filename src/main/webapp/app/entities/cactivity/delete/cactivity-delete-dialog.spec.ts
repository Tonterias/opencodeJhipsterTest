...
import { CactivityDeleteDialog } from './cactivity-delete-dialog';

describe('Cactivity Management Delete Component', () => {
  let comp: CactivityDeleteDialog;
  let fixture: ComponentFixture<CactivityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CactivityDeleteDialog);
