...
import { UrllinkDeleteDialog } from './urllink-delete-dialog';

describe('Urllink Management Delete Component', () => {
  let comp: UrllinkDeleteDialog;
  let fixture: ComponentFixture<UrllinkDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UrllinkDeleteDialog);
