...
import { AppphotoDeleteDialog } from './appphoto-delete-dialog';

describe('Appphoto Management Delete Component', () => {
  let comp: AppphotoDeleteDialog;
  let fixture: ComponentFixture<AppphotoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AppphotoDeleteDialog);
