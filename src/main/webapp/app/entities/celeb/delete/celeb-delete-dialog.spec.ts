...
import { CelebDeleteDialog } from './celeb-delete-dialog';

describe('Celeb Management Delete Component', () => {
  let comp: CelebDeleteDialog;
  let fixture: ComponentFixture<CelebDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CelebDeleteDialog);
