...
public class CommentAsserts {
    ...
    public static void assertCommentUpdatableFieldsEquals(Comment expected, Comment actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getCommentText()).as("check commentText").isEqualTo(expected.getCommentText()))
            .satisfies(a -> assertThat(a.getIsOffensive()).as("check isOffensive").isEqualTo(expected.getIsOffensive()));
    }
