...
class FeedbackResourceIT {
    ...
    public static Feedback createEntity() {
        return new Feedback().creationDate(DEFAULT_CREATION_DATE).name(DEFAULT_NAME).email(DEFAULT_EMAIL).feedback(DEFAULT_FEEDBACK);
    }
    ...
    public static Feedback createUpdatedEntity() {
        return new Feedback().creationDate(UPDATED_CREATION_DATE).name(UPDATED_NAME).email(UPDATED_EMAIL).feedback(UPDATED_FEEDBACK);
    }
    ...
    void getAllFeedbacksByCreationDateIsEqualToSomething() throws Exception {
        ...
        // Get all the feedbackList where creationDate equals to
        defaultFeedbackFiltering("creationDate.equals=" + DEFAULT_CREATION_DATE, "creationDate.equals=" + UPDATED_CREATION_DATE);
    }
    ...
    void getAllFeedbacksByCreationDateIsInShouldWork() throws Exception {
        ...
        // Get all the feedbackList where creationDate in
    ...
    void getAllFeedbacksByCreationDateIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackFiltering("creationDate.specified=true", "creationDate.specified=false");
    }
    ...
    void getAllFeedbacksByNameIsEqualToSomething() throws Exception {
        ...
        // Get all the feedbackList where name equals to
        defaultFeedbackFiltering("name.equals=" + DEFAULT_NAME, "name.equals=" + UPDATED_NAME);
    }
    ...
    void getAllFeedbacksByNameIsInShouldWork() throws Exception {
        ...
        // Get all the feedbackList where name in
        defaultFeedbackFiltering("name.in=" + DEFAULT_NAME + "," + UPDATED_NAME, "name.in=" + UPDATED_NAME);
    }
    ...
    void getAllFeedbacksByNameIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackFiltering("name.specified=true", "name.specified=false");
    }
    ...
    void getAllFeedbacksByNameContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where name contains
        defaultFeedbackFiltering("name.contains=" + DEFAULT_NAME, "name.contains=" + UPDATED_NAME);
    }
    ...
    void getAllFeedbacksByNameNotContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where name does not contain
        defaultFeedbackFiltering("name.doesNotContain=" + UPDATED_NAME, "name.doesNotContain=" + DEFAULT_NAME);
    }
    ...
    void getAllFeedbacksByEmailIsEqualToSomething() throws Exception {
        ...
        // Get all the feedbackList where email equals to
        defaultFeedbackFiltering("email.equals=" + DEFAULT_EMAIL, "email.equals=" + UPDATED_EMAIL);
    }
    ...
    void getAllFeedbacksByEmailIsInShouldWork() throws Exception {
        ...
        // Get all the feedbackList where email in
        defaultFeedbackFiltering("email.in=" + DEFAULT_EMAIL + "," + UPDATED_EMAIL, "email.in=" + UPDATED_EMAIL);
    }
    ...
    void getAllFeedbacksByEmailIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackFiltering("email.specified=true", "email.specified=false");
    }
    ...
    void getAllFeedbacksByEmailContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where email contains
        defaultFeedbackFiltering("email.contains=" + DEFAULT_EMAIL, "email.contains=" + UPDATED_EMAIL);
    }
    ...
    void getAllFeedbacksByEmailNotContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where email does not contain
        defaultFeedbackFiltering("email.doesNotContain=" + UPDATED_EMAIL, "email.doesNotContain=" + DEFAULT_EMAIL);
    }
    ...
    void getAllFeedbacksByFeedbackIsEqualToSomething() throws Exception {
        ...
        // Get all the feedbackList where feedback equals to
        defaultFeedbackFiltering("feedback.equals=" + DEFAULT_FEEDBACK, "feedback.equals=" + UPDATED_FEEDBACK);
    }
    ...
    void getAllFeedbacksByFeedbackIsInShouldWork() throws Exception {
        ...
        // Get all the feedbackList where feedback in
        defaultFeedbackFiltering("feedback.in=" + DEFAULT_FEEDBACK + "," + UPDATED_FEEDBACK, "feedback.in=" + UPDATED_FEEDBACK);
    }
    ...
    void getAllFeedbacksByFeedbackIsNullOrNotNull() throws Exception {
        ...
        defaultFeedbackFiltering("feedback.specified=true", "feedback.specified=false");
    }
    ...
    void getAllFeedbacksByFeedbackContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where feedback contains
        defaultFeedbackFiltering("feedback.contains=" + DEFAULT_FEEDBACK, "feedback.contains=" + UPDATED_FEEDBACK);
    }
    ...
    void getAllFeedbacksByFeedbackNotContainsSomething() throws Exception {
        ...
        // Get all the feedbackList where feedback does not contain
        defaultFeedbackFiltering("feedback.doesNotContain=" + UPDATED_FEEDBACK, "feedback.doesNotContain=" + DEFAULT_FEEDBACK);
    }
